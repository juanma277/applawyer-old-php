  ...
  $conexion4 = conexion();
  $sql_consultar4="SELECT ID_PERSONA, NOMBRE1,APELLIDO1,IDENTIFICACION,TELEFONO,DIRECCION,estado_persona.NOM_ESTA_PERSO as ESTADO FROM persona,estado_persona WHERE ID_PERFIL=4 AND ID_EST_PERSONA=2 AND persona.ID_EST_PERSONA = estado_persona.ID_ESTADO_PERSONA";
  ...
  $conexion4 = conexion();
  $sql_consultar4="SELECT ID_PERSONA, NOMBRE1,APELLIDO1,IDENTIFICACION,TELEFONO,DIRECCION,estado_persona.NOM_ESTA_PERSO as ESTADO FROM persona,estado_persona WHERE ID_PERFIL=4 AND ID_EST_PERSONA=1 AND persona.ID_EST_PERSONA = estado_persona.ID_ESTADO_PERSONA";
  $resultado_consulta4 = mysql_query ($sql_consultar4,$conexion4) or die (mysql_error());		
  ...
  <tr class="even pointer">
                          ...
                          <td class=" "><?php echo $fila4['DIRECCION'];?></td>
                          <td class="a-right a-right "><?php echo $fila4['ESTADO'];?></td>
                          <td class=" last"><a href="Procesar.php?opcion=2&id_persona=<?php echo $ID_PERSONA ?>" class="btn btn-info btn-xs">Inactivar</a>
                        </td>
                                                </tr>
