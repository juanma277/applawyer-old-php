...
$conexion4 = conexion();
$sql_consultar4="SELECT ID_PERSONA, NOMBRE1,APELLIDO1,IDENTIFICACION,TELEFONO,DIRECCION,estado_persona.NOM_ESTA_PERSO as ESTADO FROM persona,estado_persona WHERE ID_PERFIL<=3 AND ID_EST_PERSONA=2 AND persona.ID_EST_PERSONA = estado_persona.ID_ESTADO_PERSONA";
...
$conexion5 = conexion();
$sql_consultar5="SELECT ID_PERSONA, NOMBRE1,APELLIDO1,IDENTIFICACION,TELEFONO,DIRECCION,estado_persona.NOM_ESTA_PERSO as ESTADO FROM persona,estado_persona WHERE ID_PERFIL<=3 AND ID_EST_PERSONA=1 AND persona.ID_EST_PERSONA = estado_persona.ID_ESTADO_PERSONA";
