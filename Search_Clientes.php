...
<form action="Procesar.php?opcion=11" method="post">
...
<tr class="even pointer">
              <td class="a-center ">
                        ...
                        <td class=" last"><a href="Administracion.php?opcion=4&id_persona=<?php echo $ID_PERSONA2 ?>" class="btn btn-success btn-xs">Editar</a>
                        </td>
                                              </tr>
