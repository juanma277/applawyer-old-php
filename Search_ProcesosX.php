...
<form action="Administracion.php?opcion=22&result=1" method="post">
...
<form action="Administracion.php?opcion=22&result=3" method="post">
...
<form action="Administracion.php?opcion=22&result=4" method="post">
...
$conexion5 = conexion();
$sql_consultar5="SELECT ID_PROCESO, RADICADO,DTE,DDO,juzgado.NOM_JUZGADO AS JUZGADO ,estado_persona.NOM_ESTA_PERSO AS ESTADO FROM `proceso`,juzgado,estado_persona WHERE proceso.ID_JUZGADO = juzgado.ID_JUZGADO AND estado_persona.ID_ESTADO_PERSONA = proceso.ID_ESTAD AND proceso.RADICADO = ".$Radicado;
...
<tr class="even pointer">
              <td class="a-center ">
                        ...
                        <td class="last"><a href="Administracion.php?opcion=20&id_proceso=<?php echo $ID_PROCESO; ?>" class="btn btn-success btn-xs">Editar</a><a href="Administracion.php?opcion=22&result=2&id_proceso=<?php echo $ID_PROCESO; ?>" class="btn btn-success btn-xs">Actualizar Historial</a>
                        </td>
                 </tr>
...
mysql_close();
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Agregar historial al Proceso</h2>
                  <ul class="nav navbar-right panel_toolbox">
                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                    </li>
                  </ul>
...
mysql_close();
                  ...
                  <input type="button" value="Imprimir" class="btn btn-success btn-sm">
                  </form>
                </div>
              </div>
            </div>
...
$conexion5 = conexion();
$sql_consultar5="SELECT ID_PROCESO, RADICADO,DTE,DDO,juzgado.NOM_JUZGADO AS JUZGADO ,estado_persona.NOM_ESTA_PERSO AS ESTADO FROM `proceso`,juzgado,estado_persona WHERE proceso.ID_JUZGADO = juzgado.ID_JUZGADO AND estado_persona.ID_ESTADO_PERSONA = proceso.ID_ESTAD AND DTE LIKE '%".$Demandante."%'";
$resultado_consulta5 = mysql_query ($sql_consultar5,$conexion5) or die (mysql_error());		
...
$conexion5 = conexion();
$sql_consultar5="SELECT ID_PROCESO, RADICADO,DTE,DDO,juzgado.NOM_JUZGADO AS JUZGADO ,estado_persona.NOM_ESTA_PERSO AS ESTADO FROM `proceso`,juzgado,estado_persona WHERE proceso.ID_JUZGADO = juzgado.ID_JUZGADO AND estado_persona.ID_ESTADO_PERSONA = proceso.ID_ESTAD AND DDO LIKE '%".$Demandado."%'";
$resultado_consulta5 = mysql_query ($sql_consultar5,$conexion5) or die (mysql_error());		
