...
<form action="Procesar.php?opcion=17" method="post">

                <table class="table table-striped responsive-utilities jambo_table bulk_action">
                    <thead>
                      <tr class="headings">
                        <th>&nbsp;</th>
                        <th class="column-title" align="center" colspan="2">Buscar Empleado</th>
              ...
              <td class="a-center ">
                        ...
                        <td class=" "><input type="number" name="Iden_Empleado" required="" placeholder="Ingresa Identificación" class="form-control col-md-7 col-xs-12" ></td>
