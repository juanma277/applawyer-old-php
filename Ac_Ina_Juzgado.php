...
<form action="Procesar.php?opcion=21" method="post">
              ...
              <td class="a-center ">
                        ...
                        <td class=" ">
                        <select name="Ciudad" id="campos_de_texto" required class="form-control col-md-7 col-xs-12">
...
$conexion5 = conexion();
$sql_consultar5="SELECT ID_JUZGADO, ID_ESTADO,`NOM_JUZGADO`,ciudad.NOM_CIUDAD,estado_persona.NOM_ESTA_PERSO FROM `juzgado`,ciudad,estado_persona WHERE ciudad.ID_CIUDAD = juzgado.ID_CIUDAD AND estado_persona.ID_ESTADO_PERSONA = juzgado.ID_ESTADO AND juzgado.ID_CIUDAD = ".$id_juzgado;
...
<tr class="even pointer">
              <td class="a-center ">
						...
						if ($ID_ESTADO == 1) {
						?>
                        <a href="Procesar.php?opcion=22&id_juzgado=<?php echo $ID_JUZGADO; ?>" class="btn btn-success btn-xs">Inactivar</a>
                        <?php }else {
							?>
                            <a href="Procesar.php?opcion=23&id_juzgado=<?php echo $ID_JUZGADO; ?>" class="btn btn-success btn-xs">Activar</a>
                            <?php
						}
