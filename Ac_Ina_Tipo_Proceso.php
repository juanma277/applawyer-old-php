...
<form action="Administracion.php?opcion=17&result=1" method="post">
...
$conexion5 = conexion();
$sql_consultar5="SELECT ID_ESTADO, ID_TIPO_PROCESO, NOM_TIPO_PROCESO, estado_persona.NOM_ESTA_PERSO FROM `tipo_proceso`,estado_persona WHERE NOM_TIPO_PROCESO LIKE '%".$Tipo_Proceso."%' AND tipo_proceso.ID_ESTADO = estado_persona.ID_ESTADO_PERSONA";
...
$Estado_tipo_proceso = $fila5['ID_ESTADO'];				
...
<tr class="even pointer">
              <td class="a-center ">
                        ...
                        <td class=" last">
                        <?php
						if ($Estado_tipo_proceso == 2) 
								{
								
								?>
                                <a href="Procesar.php?opcion=27&id_tipo_proceso=<?php echo $ID_TIPO_PROCESO; ?>" class="btn btn-success btn-xs">Activar</a>
                                <?php
								} 
								else
									{
										?>
										<a href="Procesar.php?opcion=28&id_tipo_proceso=<?php echo $ID_TIPO_PROCESO; ?>" class="btn btn-success btn-xs">Inactivar</a>
                                        <?php
									}
						?>
